...
require_relative 'lib/homebus-network-latency/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-network-latency'
  spec.version = HomebusNetworkLatency::VERSION
  ...
  spec.homepage = 'https://github.com/romkey/homebus-network-latency'
  spec.license = 'MIT'
  spec.required_ruby_version = ">= #{File.read('.ruby-version')}"

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/romkey/homebus-network-latency'
